...
.post-card { background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: 0; margin-bottom: 14px; transition: border-color .15s, transform .15s; display: flex; align-items: stretch; gap: 0; overflow: hidden; }
.post-card:hover { border-color: var(--accent); transform: translateY(-1px); }
.post-card .post-thumb { width: 150px; align-self: stretch; object-fit: cover; flex-shrink: 0; background: var(--tag-bg); display: block; }
.post-card .post-body { flex: 1; min-width: 0; padding: 16px 20px; }
@media (max-width: 560px) { .post-card .post-thumb { width: 110px; } .post-card .post-body { padding: 14px 16px; } }
